...
const nameReader_1 = require("./readers/nameReader");
const propsReader_1 = require("./readers/propsReader");
const dataReader_1 = require("./readers/dataReader");
(function (file) {
    ...
    traverse_1.default(ast, {
        ...
        ExportDefaultDeclaration(rootPath) {
            ...
            data = dataReader_1.default(nodeOfVueOptions);
        }
    });
    const ci = {
        comment,
